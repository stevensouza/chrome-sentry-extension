...
3. Click the RELOAD button on "Extension Security Auditor"
4. Open dashboard and do **Cmd+Shift+R** (Mac) or **Ctrl+Shift+R** (Windows)

## Method 2: Complete Reinstall
1. Go to `chrome://extensions/`
2. Click "Remove" on "Extension Security Auditor"
3. Close ALL Chrome windows
4. Reopen Chrome
5. Go to `chrome://extensions/`
6. Click "Load unpacked"
7. Select this folder: `/Users/stevesouza/my/data/gitrepo/extension-security-audit-chrome-ext`
